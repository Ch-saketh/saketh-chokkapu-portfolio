    ...
    >
      ...
      <div className="relative h-full w-full flex items-center">
        ...
        <motion.div
          ...
          style={{ width: 'clamp(580px, 72%, 1400px)' }}
        >
          <img
            src={YourImg}
            alt="Saketh"
            fetchPriority="high"
            className="absolute bottom-0 right-0 h-full max-h-[175%] w-auto max-w-none object-contain object-bottom grayscale transition-all duration-700 ease-out hover:grayscale-0 hover:scale-[1.03] pointer-events-auto"
          />
        </motion.div>
      </div>

...
const MLModels: React.FC = () => {
  return (
    <section id="ml-models" className="scroll-mt-14 py-8 lg:py-16">
      <motion.div
        variants={stagger}
        initial="hidden"
        whileInView="show"
            ...
            >
              ...
              <motion.div variants={fadeUp} className="flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-4 leading-relaxed max-w-md text-background/80 text-sm sm:text-base">
                ...
                <div className="mt-8 hidden lg:block">
                  <div className="flex items-center gap-2 text-xs text-background/60 font-mono">
              ...
              <motion.div variants={fadeUp} className="space-y-6 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <Cpu size={18} className="text-background" />
                    <span className="font-mono text-base sm:text-lg font-bold break-all">
                      {mlModel.name}
                    </span>
                  </div>

                  {/* Model Description */}
                  <p className="mt-4 text-sm sm:text-base leading-relaxed text-background/90">
                    {mlModel.description}
                  </p>

                  {/* Meta Tags */}
                  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex items-center gap-2 text-xs font-mono text-background/80">

...
const LightContact: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#222222] text-[#F6F5F2] rounded-2xl px-6 py-8 sm:py-10 sm:px-10 md:py-14">
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-22 items-start opacity-100">
          ...
          >
            ...
            >
              ...
              <br />
              something
              <span className="mt-2 block font-light text-[#F6F5F2]/70">
                meaningful
              </span>
            </motion.h2>
            ...
            <motion.p
              variants={fadeUp}
              className="mt-10 max-w-lg text-lg sm:text-xl text-[#F6F5F2]/80 leading-relaxed"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mt-6 text-base tracking-wide text-[#F6F5F2]/80"
            >
          ...
          >
            <div
              className="absolute inset-0 -translate-x-4 -translate-y-4
                          rounded-3xl border border-[#F6F5F2]/20 hidden sm:block"
            />
            ...
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="relative rounded-3xl sm:border border-[#F6F5F2]/20
                       sm:p-8 lg:p-10 space-y-4 bg-[#222222] flex flex-col justify-center h-full"
            >
              {socialLinks.map((link) => (
                <motion.a
                  ...
                  className="group relative flex items-center justify-between
                           w-full rounded-2xl border border-[#F6F5F2]/20 px-6 py-5
                           bg-transparent text-[#F6F5F2] transition-all duration-300
                           hover:bg-[#F6F5F2] hover:text-[#222222] hover:border-transparent cursor-pointer"
                >
                  <div className="flex items-center gap-5">
                    <span className="p-2 rounded-full border border-[#F6F5F2]/20 group-hover:border-[#222222]/20 transition-colors">
                      {link.icon}
                    </span>
                    <div>
                    ...
                    {link.isPrimary && (
                      <span
                        className="hidden sm:flex px-3 py-1 text-[10px] uppercase tracking-wider
                                     font-bold rounded-full bg-[#F6F5F2] text-[#222222]
                                     group-hover:bg-[#222222] group-hover:text-[#F6F5F2] transition-colors"
                      >
                        {link.action}
                      </span>
                    )}
